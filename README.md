...
```shell
$ composer require "larva/laravel-ueditor:~1.0"
```
...
1. 添加下面一行到 `config/app.php` 中 `providers` 部分：
    ...
    ```php
    Larva\UEditor\UEditorServiceProvider::class,
    ```

2. 发布配置文件与资源

    ```php
    $ php artisan vendor:publish --provider='Larva\UEditor\UEditorServiceProvider'
    ```
...
1.安装和配置 [laravel-filesystem-qiniu](https://github.com/larvatecn/laravel-flysystem-qiniu)
...
> Larva\UEditor\Events\Uploading
